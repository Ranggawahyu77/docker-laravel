...
<h1 class="mb-3 text-center">{{ $title }}</h1>
  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      @else
        <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->slug }}.jpg" class="card-img-top " style="height: 400px" alt="{{ $posts[0]->category->name }}">
      @endif
        ...
        @foreach ($posts->skip(1) as $post)
          <div class="col-md-4 mb-3">
            <div class="card">
              ...
              @else
                <img src="https://source.unsplash.com/500x500?{{ $post->category->slug }}.jpg" class="card-img-top" alt="{{ $post->category->name }}">
              @endif
  ...
  <a href="/categories" class="text-decoration-none mb-4">List Categories</a>
